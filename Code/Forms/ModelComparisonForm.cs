...
namespace Cupscale.Forms
{
	public partial class ModelComparisonForm : Form
	{
		...
		static ImageProcessing.Format GetSaveFormat()
		{
			...
			if(Config.GetInt("previewFormat") == 1){ saveFormat = ImageProcessing.Format.Jpeg; }

			if(Config.GetInt("previewFormat") == 2){ saveFormat = ImageProcessing.Format.Weppy; }
		...
		static string GetSaveExt()
		{
			...
			if(Config.GetInt("previewFormat") == 1){ ext = "jpg"; }
			if(Config.GetInt("previewFormat") == 2){ ext = "webp"; }
